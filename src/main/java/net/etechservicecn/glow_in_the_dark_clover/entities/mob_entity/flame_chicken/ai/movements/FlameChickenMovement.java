package net.etechservicecn.glow_in_the_dark_clover.entities.mob_entity.flame_chicken.ai.movements;
...
public class FlameChickenMovement extends MoveControl {
    private final Mob mob;
    private final int maxTurn;
    public FlameChickenMovement(Mob mob, int maxTurn) {
        super(mob);
        this.mob=mob;
    ...
    public void tick() {
        if (this.operation==Operation.MOVE_TO){
            ...
            Vec3 vec3=get_target();
            double d0 = vec3.x - this.mob.getX();
            double d1 = vec3.z - this.mob.getZ();
            double d2 = vec3.y - this.mob.getY();
